...
function Help() {
  ...
  const [itemShown, setItemShown] = useState(number); 
    ...
    <div className="block">
      <div className="container">
        ...
        <div className="document faqdocument">
          ...
          <div className="faqCardPanelContainer">
            <div className="document__content typography">
              <div className="divOfferCardsContainer container">
                <div className="faqIconListContainer block-features__list">
                  <div className="block-features__item">
                    <div
                      className="faqIconContainer block-features__icon"
                      onClick={() => setPanelShown(text_Porucivanje)}
                      style={{
                        border:
                  ...
                  <div className="block-features__item">
                    <div
                      className="faqIconContainer block-features__icon"
                      onClick={() => setPanelShown(text_Isporuka)}
                      style={{
                        border:
                  ...
                  <div className="block-features__item">
                    <div
                      className="faqIconContainer block-features__icon"
                      onClick={() => setPanelShown(text_Reklamacije)}
                      style={{
                        border:
                  ...
                  <div className="block-features__item">
                    <div
                      className="faqIconContainer block-features__icon"
                      onClick={() => setPanelShown(text_Ostalo)}
                      style={{
                        border:
